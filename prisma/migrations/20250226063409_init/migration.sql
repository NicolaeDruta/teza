...
CREATE TABLE "Utilizator" (
    ...
    "tip" TEXT NOT NULL,
    "evalure" DOUBLE PRECISION NOT NULL,
...
-- AddForeignKey
ALTER TABLE "Rezervare" ADD CONSTRAINT "Rezervare_vehiculId_fkey" FOREIGN KEY ("vehiculId") REFERENCES "Vehicul"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
